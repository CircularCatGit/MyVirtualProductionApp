...
class ViewController: UIViewController, ARSCNViewDelegate, ARSessionDelegate {
    ...
    override func viewDidLoad() {
        ...
        // 1. Programmatically initialize the ARSCNView canvas layer safely
        ...
        // Setup Tap Gesture for 3D anchor locking
        let tapGesture = UITapGestureRecognizer(target: self, action: #selector(handleTap(_:)))
        sceneView.addGestureRecognizer(tapGesture)
        
        // 2. Programmatically construct the Record Toggle button
        ...
        // 3. Programmatically construct the 3D Model Import button
    ...
    override func viewWillAppear(_ animated: Bool) {
        ...
        // Fixed thread security restriction by assigning baseline spatial vector math uniformly
    ...
    @objc func handleTap(_ gestureRecognize: UIGestureRecognizer) {
        ...
        // Upgraded raycast architecture targeting horizontal geometric tracks natively
        ...
        if let raycastQuery = query {
            ...
            if let hitResult = results.first {
                ...
                // Clear all orientation rotations so it stands perfectly upright automatically
